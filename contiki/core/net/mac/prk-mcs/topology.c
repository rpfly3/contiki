...
{125, 126}, {126, 99}, {126, 125}, {126, 128}, {127, 99}, {127, 100}, {127, 122}, {127, 126}, {127, 129}, {125, 122}, {125, 124}, {125, 126}, {126, 99}
};
...
*/
link_t activeLinks[] = {{4, 19}, {6, 20}, {125, 124}, {126, 99}
};
uint8_t activeLinksSize = sizeof(activeLinks) / sizeof(activeLinks[0]);
linkaddr_t activeNodes[] = {4, 19, 6, 20, 99, 124, 125, 126};
